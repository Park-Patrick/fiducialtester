...
# web application at http://landmarkvalidator.pythonanywhere.com/
...
os.environ['DJANGO_SETTINGS_MODULE'] = 'landmarkvalidator.settings'
...
#import sys
#
#path = '/home/landmarkvalidator/path/to/my/app
#if path not in sys.path:
#    sys.path.append(path)
#
...
## assuming your django settings file is at '/home/landmarkvalidator/mysite/mysite/settings.py'
## and your manage.py is is at '/home/landmarkvalidator/mysite/manage.py'
#path = '/home/landmarkvalidator/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
#import sys
#
## The "/home/landmarkvalidator" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/landmarkvalidator/myproject"
#path = '/home/landmarkvalidator/path/to/flask_app_directory'
#if path not in sys.path:
#    sys.path.append(path)
#
